      ...
      <div className="mb-6 pb-3 columns is-multiline">
        <div className="column is-12 is-6-desktop mx-auto has-text-centered">
          ...
          <p className="subtitle has-text-grey mb-5">
            Our cutting-edge model offers a personalized healthcare experience
            by predicting potential diseases based on your symptoms. Whether you
            are unsure about your condition or need advice on the next steps,
            our model can guide you with tailored suggestions for diet,
            medications, and resources.
          </p>
          <div className="buttons is-centered">
            <div className="buttons is-centered">
              <a href="/product" className="button is-primary is-rounded">
                Let's Go
              </a>
            </div>
          </div>
        ...
        <div className="column is-12 is-4-desktop">
          ...
          <div className="mb-6 is-flex">
            ...
            <div className="ml-3">
              ...
              <p className="subtitle has-text-grey">
                The model uses your reported symptoms to analyze patterns and
          ...
          <div className="mb-6 is-flex">
            ...
            <div className="ml-3">
              ...
              <p className="subtitle has-text-grey">
                After diagnosing the disease, the model offers a customized diet
                plan to complement your treatment.
              </p>
            </div>
          </div>
          ...
          <div className="mb-6 is-flex">
            ...
            <div className="ml-3">
              ...
              <p className="subtitle has-text-grey">
                Receive recommendations for medications based on your disease
                prediction.
              </p>
            </div>
          </div>
        ...
        <div className="column is-12 is-4-desktop">
          ...
          <div className="mb-6 is-flex">
            ...
            <div className="ml-3">
              ...
              <p className="subtitle has-text-grey">
                The model provides links to trusted health resources, including
                articles, videos, and research papers.
              </p>
            </div>
          </div>
          ...
          <div className="mb-6 is-flex">
            ...
            <div className="ml-3">
              ...
              <p className="subtitle has-text-grey">
                Integrate the model with wearable health devices to track
                symptoms and health metrics in real time.
              </p>
            </div>
          </div>
          ...
          <div className="mb-6 is-flex">
            ...
            <div className="ml-3">
              ...
              <p className="subtitle has-text-grey">
                In addition to treating illnesses, the model provides preventive
                measures and wellness tips.
              </p>
            </div>
          </div>
        </div>
